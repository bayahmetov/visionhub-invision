...
|------|----------|-------------|
| **Free** | Бесплатно | Каталог вузов, базовые фильтры, сравнение до 3 вузов |
| **Student Pro** | 990 ₸ | AI-консультант без ограничений, Educational Twin, карьерный симулятор, приоритетная поддержка |
| **Student Premium** | 1 990 ₸ | Все из Pro + персональный roadmap, экспорт PDF, уведомления о дедлайнах, анализ шансов поступления |

#### Для университетов

| План | Цена/мес | Возможности |
|------|----------|-------------|
| **Basic** | Бесплатно | Базовый профиль вуза, публикация программ |
| **University Pro** | 49 000 ₸ | Расширенная аналитика, статистика просмотров, загрузка медиа (фото/видео), публикация анонсов |
| **University Premium** | 99 000 ₸ | Все из Pro + featured-размещение в топе, таргетированные уведомления абитуриентам, интеграция с приемной комиссией, API доступ |
| **Enterprise** | По запросу | Кастомная интеграция, выделенная поддержка, white-label решения |

### Дополнительные услуги

| Услуга | Цена | Описание |
|--------|------|----------|
| **Featured Listing** | 25 000 ₸/нед | Выделенное размещение в топе каталога |
| **Баннерная реклама** | от 50 000 ₸ | Рекламные баннеры на главной странице |
| **Аналитический отчет** | 15 000 ₸ | Детальный отчет по интересам абитуриентов к вузу |
| **Виртуальный тур** | от 100 000 ₸ | Создание 3D-тура по кампусу |
| **AI-чатбот для вуза** | от 150 000 ₸ | Кастомный AI-ассистент на сайте вуза |

### Ключевые преимущества монетизации

**Для студентов:**
- 🤖 **AI без ограничений** — неограниченные запросы к AI-консультанту
- 🎯 **Educational Twin** — симуляция образовательной траектории
- 💼 **Карьерный симулятор** — прогноз карьеры после выпуска
- 📊 **Персональная аналитика** — анализ шансов поступления
- 📱 **Push-уведомления** — напоминания о дедлайнах

**Для университетов:**
- 📈 **Расширенная аналитика** — география, демография, интересы аудитории
- 🎥 **Медиа-контент** — загрузка фото, видео, виртуальных туров
- 📢 **Анонсы и события** — публикация новостей и мероприятий
- 🎯 **Таргетинг** — отправка уведомлений целевой аудитории
- 🔗 **API-интеграция** — синхронизация с внутренними системами

### Прогноз выручки (Year 1)

```
Студенты (Pro + Premium):
• 5000 пользователей × 1 200 ₸ (средний чек) × 12 мес = 72 000 000 ₸

Университеты (Pro + Premium):
• 50 вузов × 70 000 ₸ (средний чек) × 12 мес = 42 000 000 ₸

Дополнительные услуги:
• ~10 000 000 ₸/год

ИТОГО: ~124 000 000 ₸/год (~$250 000)
```
...
- [ ] Интеграция платежной системы (Kaspi Pay, Halyk Bank)
- [ ] Партнерская программа для школ и репетиторов
